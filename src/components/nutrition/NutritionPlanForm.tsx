...
const NutritionPlanForm = ({
  ...
  const { getNutritionPlanTemplates, createPlanFromTemplate } =
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        <Card style={styles.card}>
          <Card.Title
            title={isEditing ? "Edit Nutrition Plan" : "Create Nutrition Plan"}
          />
          <Card.Content>
            <FormField
              label="Plan Name"
            ...
            <FormField
              ...
              onChangeText={(value) =>
                updateFormData("weatherCondition", value)
              }
        ...
        <Card style={styles.entriesCard}>
          <Card.Content>
            <Text style={styles.entriesTitle}>Nutrition Entries</Text>
            <Text style={styles.entriesCount}>
              {formData.entries.length}{" "}
              {formData.entries.length === 1 ? "item" : "items"} added
            </Text>
