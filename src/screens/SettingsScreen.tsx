        ...
        <View style={dynamicStyles.section}>
          ...
          >
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <View style={[styles.radioOption, { width: "100%" }]}>
                <RadioButton
                  value="miles"
                  color={paperTheme.colors.primary}
                  uncheckedColor={isDarkMode ? "#e0e0e0" : "#111112"}
                  status={
                    settings.distanceUnit === "miles" ? "checked" : "unchecked"
                  }
                />
            ...
            >
              <View style={[styles.radioOption, { width: "100%" }]}>
                <RadioButton
                  ...
                  uncheckedColor={isDarkMode ? "#e0e0e0" : "#111112"}
                  status={
                    settings.distanceUnit === "km" ? "checked" : "unchecked"
                  }
                />
          ...
          >
            <TouchableOpacity
              style={styles.radioOption}
              onPress={() => handleElevationUnitChange("ft")}
              activeOpacity={0.7}
            >
              <View style={[styles.radioOption, { width: "100%" }]}>
                <RadioButton
                  ...
                  uncheckedColor={isDarkMode ? "#e0e0e0" : "#111112"}
                  status={
                    settings.elevationUnit === "ft" ? "checked" : "unchecked"
                  }
                />
            ...
            <TouchableOpacity
              style={styles.radioOption}
              onPress={() => handleElevationUnitChange("m")}
              activeOpacity={0.7}
            >
              <View style={[styles.radioOption, { width: "100%" }]}>
                <RadioButton
                  ...
                  uncheckedColor={isDarkMode ? "#e0e0e0" : "#111112"}
                  status={
                    settings.elevationUnit === "m" ? "checked" : "unchecked"
                  }
                />
